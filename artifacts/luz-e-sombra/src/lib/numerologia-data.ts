...
• CORAGEM CALCULADA: Não é impulsividade, mas coragem fundamentada. Arrisque-se, mas com planejamento. Seja ousado(a), mas não inconsequente.`,
  ...
  2: {
    ...
    detalhado: `Propósito central: Cultivar parcerias autênticas, aprofundar sensibilidade emocional e aprender a negociar sem perder-se.

Temas principais:
• PARCERIAS ESTRATÉGICAS: As sementes plantadas no Ano 1 precisam de colaboradores para florescer. Identifique quem pode ser um parceiro genuíno — em negócios, projetos e na vida pessoal.

• PACIÊNCIA COMO ESTRATÉGIA: O 2 ensina que nem tudo precisa de ação imediata. Esperar o momento certo, observar e acumular informações é um poder silencioso que poucos dominam.

• INTELIGÊNCIA EMOCIONAL: Suas percepções emocionais estão aguçadas. Use essa sensibilidade para entender o que está além das palavras — nas negociações, nas relações e em você mesmo(a).

• DIPLOMACIA: Conflitos não resolvidos pedem atenção. Este é o momento de reparar pontes, negociar acordos e curar relações que precisam de atenção.`,
    temas: {
  ...
  3: {
    ...
    detalhado: `Propósito central: Expressar o que foi interno, comunicar com autenticidade e expandir através da criatividade.

Temas principais:
• EXPRESSÃO CRIATIVA: Seja em que forma for — escrita, fala, música, dança, projetos visuais — este é o ano de criar e compartilhar. O que estava esperando "o momento certo"? Esse momento é agora.

• SOCIALIZAÇÃO INTENCIONAL: Sua rede de contatos se expande naturalmente. Aproveite para cultivar conexões que alimentam tanto profissionalmente quanto emocionalmente.

• COMUNICAÇÃO TRANSFORMADORA: Suas palavras têm impacto elevado. Discursos, publicações, conteúdo digital, apresentações — tudo que você comunicar com autenticidade reverbera mais longe.

• ALEGRIA COMO PRÁTICA: Não como superficialidade, mas como escolha consciente. Cultivar alegria em um mundo pesado é um ato de resistência e generosidade.`,
    temas: {
  ...
  4: {
    ...
    detalhado: `Propósito central: Construir com método, disciplina e comprometimento as estruturas que sustentarão o ciclo inteiro.

Temas principais:
• ORGANIZAÇÃO COMO PODER: Organize finanças, documentos, projetos e rotinas. O que está bagunçado drena energia sem que você perceba. A arrumação externa reflete e cria a interna.

• TRABALHO CONSISTENTE: Não é um ano de flashes de genialidade — é de resultados construídos tijolo a tijolo. Respeite o processo. O que você construir aqui durará.

• SAÚDE COMO FUNDAÇÃO: Cuide do corpo com a seriedade de quem sabe que é seu único veículo de manifestação. Rotinas de exercício, sono e alimentação constroem a base para tudo mais.

• PLANEJAMENTO DE LONGO PRAZO: Pense em horizontes de 3 a 5 anos. O que você quer ter construído? Mapeie o caminho hoje.`,
    temas: {
  ...
  5: {
    ...
    detalhado: `Propósito central: Liberdade consciente, adaptação criativa e expansão através da experiência direta.

Temas principais:
• MUDANÇAS COMO MESTRA: Neste ano, o inesperado é o planejado. Resistir à mudança será mais custoso do que abraçá-la. Desenvolva confiança na vida como um processo inteligente.

• LIBERDADE RESPONSÁVEL: Liberdade não é ausência de compromissos — é a capacidade de viver com autenticidade mesmo dentro das estruturas necessárias. Revise o que te limita desnecessariamente.

• NOVAS EXPERIÊNCIAS: Saia da zona de conforto com intenção. Viaje, conheça pessoas diferentes, experimente formas de trabalho ou relacionamento que ainda não experimentou. A expansão vem da experiência.

• VERSATILIDADE: Sua capacidade de adaptação é seu maior ativo este ano. Quem se agarra ao que era antes do 5 tende a sofrer mais.`,
    temas: {
  ...
  6: {
    ...
    detalhado: `Propósito central: Responsabilidade amorosa, harmonia nos relacionamentos e serviço ao bem-estar coletivo próximo.

Temas principais:
• FAMÍLIA E LAR: Questões familiares pedem atenção — seja para fortalecer vínculos, resolver conflitos antigos ou redesenhar dinâmicas. O lar interno (sua paz) e o externo (seu espaço físico) pedem cuidado.

• COMPROMISSO COM AMOR: Formalização de relacionamentos, casamentos, parcerias. Também é o momento de clarificar compromissos que existem de fato (sem papel formal) ou de finalizar o que já não tem substância.

• BELEZA E ESTÉTICA: O 6 é o número da beleza. Cuide do seu ambiente físico. Redecorações, renovações, organização do espaço impactam diretamente seu bem-estar emocional.

• LIMITES COM AMOR: Dizer não quando necessário, sem culpa, é um ato de amor — por você e pelos outros. Aprenda este equilíbrio sofisticado.`,
    temas: {
  ...
  7: {
    ...
    detalhado: `Propósito central: Aprofundamento intelectual e espiritual, refinamento interno e planejamento estratégico baseado em sabedoria.

Temas principais:
• ESTUDO PROFUNDO: Não é ano de lançamentos e expansão — é de aprofundamento. Especialização, pesquisa, leituras transformadoras. O que você aprende agora alimentará os próximos ciclos.

• INTROSPECÇÃO: Pratique autoconhecimento com seriedade. Terapia, journaling, meditação, retiros. As respostas que você precisa estão dentro, não fora.

• PLANEJAMENTO ESTRATÉGICO: O 7 é excelente para planejar o que virá no 8 (ano de colheita). Pesquise, avalie, refine. Decisões tomadas com pesquisa profunda aqui terão resultados excepcionais no próximo ciclo.

• SELETIVIDADE SOCIAL: Reduza compromissos que drenam sem nutrir. A quantidade de relações cede lugar para a qualidade da presença.`,
    temas: {
  ...
  8: {
    ...
    detalhado: `Propósito central: Manifestação material, liderança executiva e alinhamento entre poder pessoal e propósito.

Temas principais:
• COLHEITA PROPORCIONAL: Você colhe o que plantou nos ciclos anteriores. Este é o momento de exigir o que é seu — promoções, contratos, reconhecimento e crescimento financeiro.

• LIDERANÇA EXECUTIVA: Assuma posições de liderança e responsabilidade. O 8 favorece quem age com autoridade e ética. Liderança com integridade gera resultados duradouros.

• PODER PESSOAL: Trabalhe sua relação com poder, dinheiro e autoridade. O 8 amplifica desequilíbrios nessa área. Se você tem medo de dinheiro ou poder, eles fugirão. Se os busca por insegurança, voltarão para ensiná-lo(a).

• GESTÃO ESTRATÉGICA: Planejamento financeiro detalhado, auditorias, contratos claros. Este é o ano de tratar negócios como negócios — com profissionalismo e visão.`,
    temas: {
  ...
  9: {
    ...
    detalhado: `Propósito central: Encerramento consciente de ciclos, liberação do que não serve mais e preparação do terreno para o novo.

Temas principais:
• ENCERRAMENTOS NECESSÁRIOS: Projetos, relacionamentos, crenças, padrões de comportamento — o que ainda não foi finalizado pede atenção. Não arraste para o próximo ciclo o que precisa ser encerrado aqui.

• LIBERAÇÃO E DESAPEGO: Pratique o desapego ativo. Doe o que não usa, perdoe quem ainda carrega, complete processos inacabados. Cada liberação cria espaço para o novo.

• COMPAIXÃO UNIVERSAL: O 9 expande o coração para além do ego individual. Causas maiores, contribuição social, humanitarismo. Sua presença em serviço ao coletivo tem impacto ampliado.

• SABEDORIA DO CICLO: Reflita sobre os 9 anos que passaram. O que aprendeu? O que construiu? O que precisa levar para o próximo ciclo e o que deve ficar para trás?`,
    temas: {
  ...
  11: {
    ...
    detalhado: `Propósito: Despertar espiritual acelerado, liderança por inspiração e materialização de insights elevados.

Temas principais:
• INTUIÇÃO AGUÇADA: Confie mais do que nunca nas suas percepções internas. O 11 amplifica a captação de informações sutis. Sua antena está no pico.

• LIDERANÇA INSPIRADORA: Pessoas serão atraídas pela sua presença e visão. Você está sendo chamado(a) a liderar — não pelo cargo, mas pela luz que carrega.

• ANCORAGEM PRÁTICA: O risco do 11 é o misticismo sem aplicação. Cada insight espiritual precisa encontrar forma concreta na vida real.`,
    temas: {
  ...
  22: {
    ...
    detalhado: `Propósito: Manifestar projetos de impacto coletivo com visão espiritual e execução prática impecável.

Temas principais:
• GRANDE ESCALA: Pense maior do que parece razoável — mas planeje com mais rigor do que parece necessário.

• LIDERANÇA RESPONSÁVEL: Com grande poder vem grande responsabilidade. Cada decisão tem impacto amplificado.

• INTEGRAÇÃO VISÃO-EXECUÇÃO: Sua maior habilidade este ano é transformar visões em realidades palpáveis.`,
    temas: {
