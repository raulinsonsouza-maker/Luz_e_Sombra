...
const ESTRUTURAS: Record<string, {
  ...
  psicopata: {
    ...
    arquetipo: "O Estrategista Magnético",
    padraoProfundo: "Você opera com uma inteligência estratégica natural e um magnetismo que as pessoas percebem imediatamente. Sua mente calcula movimentos e consequências com eficiência rara.",
    sombra: "A desconexão emocional pode ser usada como escudo, tornando relações superficiais. O medo de vulnerabilidade real é o que separa o poder verdadeiro do poder performático.",
    dominancias: ["Liderança carismática e natural", "Inteligência estratégica aguçada", "Capacidade de persuasão e influência", "Ação decisiva sob pressão"],
    relacionamento: "Você atrai pessoas com facilidade, mas a profundidade da conexão depende da sua disposição de ser visto sem a armadura da performance.",
  },
  masoquista: {
    nome: "Masoquista",
    cor: "#6db96d",
  ...
  rigido: {
    ...
    arquetipo: "O Construtor de Excelência",
    padraoProfundo: "Você opera com um padrão interno de alta performance e comprometimento com a qualidade. Sua disciplina e integridade criam resultados que outros admiram — mas internamente, a régua raramente descansa.",
    sombra: "O medo de falhar ou ser visto como imperfeito pode criar uma rigidez que impede a entrega verdadeira. Perfeição como escudo é o que separa o sucesso exterior da realização interior.",
    dominancias: ["Disciplina e comprometimento genuínos", "Presença impactante e confiável", "Integridade como valor real, não performance", "Capacidade de construir resultados duradouros"],
    relacionamento: "Você é parceiro(a) confiável e presente — mas a intimidade emocional exige que você baixe a guarda. Parceiros precisam te ver por trás da excelência.",
  },
};
...
function gerarInsightsCruzados(params: {
  ...
  if (vidaNum && estrutura) {
    const combos: Record<string, Record<string, string>> = {
      ...
      psicopata: {
        "1": `Caminho ${vidaNum} Pioneiro com estrutura de Estrategista: combinação de liderança pura. Você tem o instinto, o magnetismo e a visão. O que separa o potencial da realização plena é a disposição de ser vulnerável — de liderar não apenas com força, mas com humanidade.`,
        ...
        "default": `Caminho ${vidaNum} com estrutura Estrategista: você move o mundo com competência e presença. O desafio é integrar o coração à estratégia — porque os resultados mais duradouros vêm de poder que carrega propósito.`,
      },
      masoquista: {
        "4": `Caminho ${vidaNum} Construtor com estrutura de Portador Silencioso: você constrói com uma persistência que beira o sobre-humano. O perigo está na fronteira entre construir com propósito e suportar o que não deveria ser suportado. Aprenda a distinguir.`,
        "6": `Caminho ${vidaNum} Guardião com estrutura Masoquista: você carrega os outros com uma lealdade impressionante. Mas quem carrega o portador? Sua jornada mais importante é descobrir que você pode pedir suporte sem perder a identidade.`,
        "default": `Caminho ${vidaNum} com estrutura Masoquista: sua força silenciosa é real e impressionante. Mas ela foi construída como resposta a um mundo que não sempre honrou sua voz. Agora é a hora de descobrir o que acontece quando você fala.`,
      },
      rigido: {
        "1": `Dois sistemas de liderança e excelência: Caminho ${vidaNum} Pioneiro com estrutura Rígida. Você tem padrões altos e a capacidade de entregá-los. O que pode estar faltando é a permissão para ser imperfeito(a) no processo — porque a perfeição como requisito pode paralisar até o mais corajoso dos pioneiros.`,
        "8": `Caminho ${vidaNum} Realizador com estrutura de Construtor de Excelência: poucos têm essa combinação de poder e integridade. O desafio mais profundo é a flexibilidade — porque nem toda grande construção precisa ser perfeita, e nem toda grande conquista exige sacrifício total.`,
        "default": `Caminho ${vidaNum} com estrutura Rígida: você entrega com qualidade e confiabilidade. Sua palavra vale. O convite é para descobrir que você também pode ser real, com falhas, com incertezas — e ainda assim ser digno(a) de amor e respeito.`,
      },
    };
